...
$(document).ready( function() {
  ...
  $('#accountResults').on('click', '.schedule', function() {
    ...
    $.post('{{ site_path }}/task/addtask', {"lists":tags,"action":"autofollowtags","accid":activeId,"delay":"1h","threads":maxHour,"max":maxDay,"job_max":maxTotal}, function(data) {
  ...
  $('.aside-list-item').on('click', function() {
    ...
    $.post('{{ site_path }}/accounts/loadaccount/followshashtags', {"accid":accId}, function(data) {
      ...
      <div id="tooltip_content">
        <div class="sidebar-sub-links">
          <ul>
            ...
            <li class="active"><a href="{{ site_path }}/accounts/follows/hashtags">Autofollow by Hashtags</a></li>
          </ul>
        </div>
      </div>
