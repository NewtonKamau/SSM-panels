...
$(document).ready( function() {
  ...
  $('#accountResults').on('click', '.schedule', function() {
    ...
    $.post('{{ site_path }}/task/addtask', {"action":"autounfollows","accid":activeId,"delay":"1h","threads":maxHour,"max":maxDay,"job_max":maxTotal}, function(data) {
  ...
  $('.aside-list-item').on('click', function() {
    ...
    $.post('{{ site_path }}/accounts/loadaccount/unfollows', {"accid":accId}, function(data) {
  ...
  <nav class="sidebar-scroll" id="sidebar">
    <div class="hor-menu">
        ...
        <ul class="mt-3 mb-5">
          ...
          <li data-type="accounts" data-sidebar="unfollows" data-icons="unfollows" title="Auto Unfollow" class="sidebar-link title-tooltip active"></li>
...
<div class="content-scroll" id="content" style="width:100%;">
  <nav id="topNav" class="navbar navbar-expand-md navbar-light">
      <h1 class="topbar-title">Auto Unfollow</h1>
