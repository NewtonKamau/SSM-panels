...
$(document).ready( function() {
  ...
  $('#accountResults').on('click', '.schedule', function() {
    ...
    $.post('{{ site_path }}/task/addtask', {"lists":locationsIds,"action":"autolikelocations","accid":activeId,"delay":"1h","threads":maxHour,"max":maxDay,"job_max":maxTotal}, function(data) {
  ...
  $('.aside-list-item').on('click', function() {
    ...
    $.post('{{ site_path }}/accounts/loadaccount/likeslocation', {"accid":accId}, function(data) {
      ...
      <div id="tooltip_content_likes">
        <div class="sidebar-sub-links">
          <ul>
            ...
            <li class="active"><a href="{{ site_path }}/accounts/likes/location">Auto Like by Location</a></li>
...
<div class="content-scroll" id="content" style="width:100%;">
  <nav id="topNav" class="navbar navbar-expand-md navbar-light">
      <h1 class="topbar-title">Auto Likes by Location</h1>
