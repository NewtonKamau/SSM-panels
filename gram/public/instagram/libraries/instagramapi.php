            ...
            switch ($data->type) {
                case 'photo':
                    if(check_image($media[0])){
                        ...
                        //Auto Resize
                        $media[0] = instagram_image_handlers($media[0], "photo", $data->uid);
                ...
                case 'story':
                    if(check_image($media[0])){
                        ...
                        //Auto Resize
                        $media[0] = instagram_image_handlers($media[0], "story", $data->uid);
                ...
                case 'carousel':
                    ...
                    foreach ($media as $item) {
                        ...
                        if(!empty($image_info)){
                            ...
                            //Auto Resize
                            $item = instagram_image_handlers($item, "carousel", $data->uid);
